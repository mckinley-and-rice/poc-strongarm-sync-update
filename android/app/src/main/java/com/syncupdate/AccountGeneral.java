...
public class AccountGeneral {
     ...
     */
    private static final String ACCOUNT_TYPE = "com.syncupdate.syncaccount";

    /**
     * This is the name that appears in the Android 'Accounts' settings.
     */
    private static final String ACCOUNT_NAME = "Sync Update";
    ...
    public static void createSyncAccount(Context c) {
        ...
        if (manager.addAccountExplicitly(account, null, null)) {
            final String AUTHORITY = AthleteContract.CONTENT_AUTHORITY;
